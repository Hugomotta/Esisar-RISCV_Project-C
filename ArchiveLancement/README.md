...
Auteurs : PRÉNOM NOM et PRÉNOM NOM

## Rendu 1

* Cochez (en remplaçant `[ ]` par `[x]`) si vous avez :
  - [ ] Vérifié que `make test` se plaint sur le nombre d'instructions et pas
      sur l'existence des fichiers de sortie.
  - [ ] Vu sur Chamilo que les soumissions se font avec `make tar`.
